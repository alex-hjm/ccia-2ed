...
[代码2.6](source/02-thread/listing_2.6.cpp)  scoped\_thread的用法
...
[代码3.2](source/03-share-data/listing_3.2.cpp) 无意中传递了保护数据的引用
...
[代码3.8](source/03-share-data/listing_3.8.cpp)  简单的层级互斥量实现
...
[代码4.5](source/04-synchonizing/listing_4.5.cpp) 使用条件变量的线程安全队列(完整版)
...
完整代码：[代码 atm](source/04-synchonizing/atm.cpp)
...
[代码4.17](source/04-synchonizing/listing_4.17.cpp) 使用并发技术扩展规范中的特性，实现与`std::async`等价的功能
...
[代码4.20](source/04-synchonizing/listing_4.20.cpp) 处理用户登录——持续性方式
...
[代码4.22](source/04-synchonizing/listing_4.22.cpp) 使用`std::async`从多个future中收集结果
...
[代码4.24](source/04-synchonizing/listing_4.24.cpp)使用` std::experimental::when_any `处理第一个被找到的值
...
[代码4.25](source/04-synchonizing/listing_4.25.cpp) 使用` std::experimental::latch`等待所有事件
...
[代码4.26](source/04-synchonizing/listing_4.26.cpp)` std::experimental::barrier`的用法
...
[代码4.27](source/04-synchonizing/listing_4.17.cpp) 使用`std::experimental::flex_barrier`管理串行部分
